...
Select
 ...
 qtycnt,
 qtydmg,
 substr(tagtxt,1,9) as @comnt,
 substr(tagtxt,10,11) as @nada,
 substr(tagtxt,21,12) as @lotnb,
 substr(tagtxt,33,6) as @lotda,
 substr(tagtxt,39,6) as @tag06,
 substr(tagtxt,45,1) as @tagcd,
 substr(tagtxt,46,25) as @tagnb,
 itmseq
From pinv
;
